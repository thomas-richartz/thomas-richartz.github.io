...
import { RandomPictureViewMode, Screen } from "@/enums";
...
export const LandingScreen = ({ onCatClick, onNavigate }: ILandingScreen): JSX.Element => {
  ...
  return (
    <div className={`${styles.fadeStyles} ${hide ? styles.fadeStylesHidden : ""}`}>
      <div className={styles.gallerySliderWrap} onClick={() => onNavigate(Screen.GALLERY)} style={{ cursor: "pointer" }}>
        <img className={`${styles.centeredImage} ${styles.imageProfile}`} src="/assets/img/thomas-richartz.jpg" alt="thomas-richartz" />
